      ...
      <div className="pdp-container">
        ...
        <div className="pdp-details primary">
          ...
          <div className="pdp-size">
            <th>
              ...
              {size.length
                ? size.map(itemSize => (
                    <button
                      onClick={() => selectSize(itemSize)}
                      className={`${
                        selectedSize === itemSize ? "selected-size" : ""
                      } text-center`}
                    >
                      {itemSize[0].toUpperCase()}
                    </button>
                  ))
                : ""}
            </th>
          ...
          <div className="pdp-price">
            <div class="pb-2">
              <h3 class="d-inline">${ppm}</h3>
              <p class="d-inline">per month</p>
            </div>
            <h5>${price}</h5>
          </div>
        </div>
        <div className="pdp-add-to-cart mt-3">
          <button
            onClick={() => addToCart(createCartProduct())}
