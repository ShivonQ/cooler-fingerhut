        ...
        <div className="row">
          ...
          <div className="col-sm-4 col-md-3">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a className="text-light" href="#">
                  Manufacturer Contact <br /> Information
                </a>
              </li>
              <li>
                <a className="text-light" href="#">
          ...
          <div className="col-sm-4 col-md-3">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a className="text-light" href="#">
                  Fingerhut Advantage Terms and Conditions
                </a>
              </li>
              <li>
                <a className="text-light" href="#">
              ...
              <li>
                <a
                  ...
                  href="http://ats.eccmp.com/ats/show.aspx?cr=571&amp;fm=21"
                  title="Download the Mobile App!"
                  data-track-id="globalFooter_link"
                  data-track-value="Download Mobile App"
                >
                  <img
                    alt=""
                    src="https://www.fingerhut.com/assets/f/app_icon_footer.png"
                  />
                  <br />
        ...
        <div className="container-fluid">
          <p>
            <small>
              ...
              accessibility of this website to ensure that persons with
              disabilities have full and equal enjoyment of the goods, services,
          ...
          <div className="disclaimers padding padding-size-lg">
            ...
            <p>
              <small>
                * <strong>Advertised Price Per Month:</strong> The advertised
                ...
                items on it, then please see the payment chart for payment
            ...
            <p>
              <small>
                ...
                assumption of interest charges and SafeLine fees, as applicable.
                The change in minimum payment amount does not include subsequent
                activity on your account such as any purchases, including
                deferred payment purchases, backordered, unshipped, returned or
                other pending purchases or exchanges; any payments, including
                partial, missed or returned payments; any fees, including
                recurring partner program charges, subsequent interest charges,
                late fees or returned payment fees. It is also subject to change
                based on shipping address, shipping method, partial shipments
                and taxes. Your minimum payment amount will not change and the
            ...
            <small>
              ...
              for the terms of credit.
            </small>
            <small>
              2. Please see our complete WebBank/Fingerhut Advantage Credit
              Account{" "}
              <a
            ...
            <small className="copyright">
              © 2002-2020 Bluestem Brands, Inc. Fingerhut.com and designs are
              trademarks of Bluestem Brands, Inc. All rights reserved.
            </small>
          </div>
        </div>
      </div>
